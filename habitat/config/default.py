...
_C.TASK.TOP_DOWN_MAP.MAP_PADDING = 3  #chng 3
_C.TASK.TOP_DOWN_MAP.NUM_TOPDOWN_MAP_SAMPLE_POINTS = 50   ##chng 20000
_C.TASK.TOP_DOWN_MAP.MAP_RESOLUTION = 500 ##chng 1250
_C.TASK.TOP_DOWN_MAP.DRAW_SOURCE = False ##chng True
_C.TASK.TOP_DOWN_MAP.DRAW_BORDER = False ##chng True
_C.TASK.TOP_DOWN_MAP.DRAW_SHORTEST_PATH = False ##chng True
_C.TASK.TOP_DOWN_MAP.FOG_OF_WAR = CN()
_C.TASK.TOP_DOWN_MAP.FOG_OF_WAR.DRAW = False ##chng True
_C.TASK.TOP_DOWN_MAP.FOG_OF_WAR.VISIBILITY_DIST = 5.0
_C.TASK.TOP_DOWN_MAP.FOG_OF_WAR.FOV = 90
_C.TASK.TOP_DOWN_MAP.DRAW_VIEW_POINTS = False ##chng True
_C.TASK.TOP_DOWN_MAP.DRAW_GOAL_POSITIONS = False ##chng True
# Axes aligned bounding boxes
_C.TASK.TOP_DOWN_MAP.DRAW_GOAL_AABBS = False ##chng True
# -----------------------------------------------------------------------------
