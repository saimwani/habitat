...
def draw_top_down_map(info, heading, output_size):
    ...
    # top_down_map = maps.draw_agent(   ##chng
    #     top_down_map,
    #     map_agent_pos,
    #     heading - np.pi / 2,
    ...
    patch=top_down_map[map_agent_pos[0]+top-40:map_agent_pos[0]+top+40, map_agent_pos[1]+left-40:map_agent_pos[1]+left+40]
...
def shortest_path_example(mode):
    ...
    for episode in range(30):
        ...
        #     # im = observations["rgb"]  ##CHNG
        #     # top_down_map = draw_top_down_map(
        #     #     info, observations["heading"][0], im.shape[0]
        #     # )

        #     top_down_map = draw_top_down_map(   ##CHNG
        #         info, observations["heading"][0], 256
        #     )
        #     output_im = np.concatenate((im, top_down_map), axis=1)
        #     # img = Image.fromarray(top_down_map, 'RGB')
        #     # img.save('my.png')
        #     # img.show()
